...
import {HomeOutlined,StepBackwardOutlined,StepForwardOutlined} from '@ant-design/icons'
    ...
    <div className='HomeColumnOne' >
      <div >
        <Breadcrumb className='bread-crumb'>
          <Breadcrumb.Item><HomeOutlined /><a href='#/'>home</a> </Breadcrumb.Item>
          <Breadcrumb.Item><a href='#/BookOne'>BookOne</a></Breadcrumb.Item>
          <Breadcrumb.Item><a href='#/Character1'>解读1</a></Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div className='Route'>
        <Button className='back-button' icon={<StepBackwardOutlined />}>第一章</Button>
        <Button className='forward-button'>下一篇<StepForwardOutlined /></Button>
      </div>
      <h1>解读1</h1>
      <p>世界会走向哪里？
作者： 阮一峰
...
人类社会究竟走向哪里：忍受现实的不平等，还是在虚拟中重构平等？未来从来没有像现在这般扑朔迷离，令人琢磨不透</p>
      <div className='Route'>
        <Button className='back-button'>第一章</Button>
        <Button className='forward-button'>下一篇</Button>
      </div>
      <TimeComponent />
      <CommentApp />
    </div>
